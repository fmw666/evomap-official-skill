...
OUTPUT=$(node "$TEST_WORKSPACE/scripts/render_template.js" "help.md" "en")
...
OUTPUT=$(node "$TEST_WORKSPACE/scripts/render_template.js" "ghost_template.md" "en")
...
node "$TEST_WORKSPACE/scripts/config_manager.js" "set" "language" "en" > /dev/null
